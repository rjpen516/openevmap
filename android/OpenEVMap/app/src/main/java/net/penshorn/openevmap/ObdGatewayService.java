...
import net.penshorn.openevmap.SettingsFragment;
//import com.github.pires.obd.reader.activity.ConfigActivity;
//import com.github.pires.obd.reader.activity.MainActivity;
import net.penshorn.openevmap.ObdCommandJob.ObdCommandJobState;
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() throws IOException {
        ...
        if (remoteDevice == null || "".equals(remoteDevice)) {
            Toast.makeText(ctx, "No Device Selected", Toast.LENGTH_LONG).show();
